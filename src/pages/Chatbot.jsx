          ...
          >
            ...
            {loadingMemory ? (
              ...
              <>
                ...
                <div style={{ marginBottom: '20px' }}>
                  <h3 style={{ margin: '0 0 8px 0', fontSize: 14, fontWeight: 600, color: '#a6a1a1' }}>Recent Messages ({memoryData.recentMessages?.length || 0})</h3>
                  <div style={{ maxHeight: '200px', overflowY: 'auto', backgroundColor: '#1e1a19ff', borderRadius: '8px', padding: '8px' }}>
                    {memoryData.recentMessages?.map((msg, idx) => (
                      <div key={idx} style={{ padding: '6px 8px', borderBottom: idx < memoryData.recentMessages.length - 1 ? '1px solid #2a3a4a' : 'none' }}>
                        <span style={{ fontWeight: 600, color: msg.role === 'user' ? '#3a5a9d' : '#7a8692' }}>{msg.role}:</span>{' '}
